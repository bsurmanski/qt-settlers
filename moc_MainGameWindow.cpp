...
const QMetaObject MainGameWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_MainGameWindow,
      qt_meta_data_MainGameWindow, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MainGameWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MainGameWindow))
        return static_cast<void*>(const_cast< MainGameWindow*>(this));
