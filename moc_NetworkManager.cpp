...
**
** Created: Sat Jul 16 22:16:00 2011
...
static const char qt_meta_stringdata_NetworkManager[] = {
    "NetworkManager\0\0server_newConnect()\0"
    "server_parsePackets()\0client_parsePackets()\0"
    "client_getConnect()\0"
};
...
int NetworkManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: server_newConnect(); break;
        case 1: server_parsePackets(); break;
        case 2: client_parsePackets(); break;
        case 3: client_getConnect(); break;
        default: ;
        }
        _id -= 4;
    }
